...
train_step = tf.train.GradientDescentOptimizer(0.2).minimize(loss)  # GradientDescentOptimizer里给学习率,且小于1
...
plt.ion()  # 加上这句show的时候不暂停 # 3.5版本之后
plt.show()  # show 的时候程序暂停了
